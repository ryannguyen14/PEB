...
% One Classifer
sprintf('Using features 7 and 8 we successfully classified %1.1f%% of SNVs in the test data', succ_rate*100)
%% Notes on Tables
% 
...
colorMap = [zeros(length(x_test), 1), zeros(length(x_test), 1), ones(length(x_test),1)];
...
xlabel('Feature 8','interpreter','latex');
ylabel('Feature 7','interpreter','latex');
% % You can also add a title to your plot
title('Classification Results as a Function of 2 Features','interpreter','latex');
