...
%[Mean, STD, Median] = VectorStatistics(CoinCounts); 

Quartiles = zeros(1,4);
j = 0; 
for p = 0:0.25:1
    Quartiles(j) = quantiles(CoinCounts, p); 
    j = j + 1; 
end 
...
histogram(CoinCounts,'BinEdges', bin_edges,'Normalization', 'pdf');
...
[col1, col2, col3] = data_cell{[4,5,6]};
