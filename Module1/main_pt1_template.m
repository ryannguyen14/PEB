...
plot(polarization_array{4,1});
plot(polarization_array{5,1});
plot(polarization_array{6,1});
...
% create legend
legend({['Fish 1'], ['Fish 2'],['Fish 3'],['Fish 4'], ['Fish 5'], ['FIsh 6']},'interpreter','latex','location','best');
...
plot(polarization_array{4,2});
plot(polarization_array{5,2});
plot(polarization_array{6,2});
...
plot(polarization_array{4,3});
plot(polarization_array{5,3});
plot(polarization_array{6,3});
...
ylabel(['MSD ($\mu \textnormal{m}^{2}$)'],'interpreter','latex');
